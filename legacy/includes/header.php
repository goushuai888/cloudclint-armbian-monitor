...
<head>
    ...
    <!-- 核心样式表 - 统一加载 -->
    <?php 
    // 强制缓存清理 - ULTRATHINK重构版本
    $cache_buster = time() . '_ultrathink_v2'; 
    ?>
    
    <!-- Bootstrap 核心样式 -->
    <link href="assets/css/bootstrap.min.css?v=<?php echo $cache_buster; ?>" rel="stylesheet">
    <link href="assets/css/bootstrap-icons.css?v=<?php echo $cache_buster; ?>" rel="stylesheet">
    
    <!-- CloudClint 统一样式 - ULTRATHINK重构版 -->
    <link href="assets/css/cloudclint-unified.css?v=<?php echo $cache_buster; ?>" rel="stylesheet">
    
    <!-- 核心JavaScript库 -->
    <!-- Bootstrap JavaScript -->
    <script src="assets/js/bootstrap.bundle.min.js?v=<?php echo $cache_buster; ?>" defer></script>
    
    <!-- CloudClint 统一脚本 - ULTRATHINK重构版 -->
    <script src="assets/js/cloudclint-unified.js?v=<?php echo $cache_buster; ?>" defer></script>
